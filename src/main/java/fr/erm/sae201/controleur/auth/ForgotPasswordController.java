 ...
 * MODIFIÉ: Gère l'exception si l'email n'est pas trouvé.
 */
public class ForgotPasswordController {
    ...
    private void handleSendCode() {
        ...
        try {
            // MODIFIÉ : authService.sendResetCode lève maintenant une exception si l'email n'est pas trouvé.
            ...
            // MODIFIÉ : Capture de l'exception si l'email n'existe pas.
